...
print(os.path.dirname(caminho))     # Mostra apenas o caminho todo do diretorio
print(os.path.abspath('.'))     # Verifica diretorio atual
print(os.path.basename(caminho))       # Mostra a parte final do arquivo 
print(os.path.exists('../../../../../Documentos/git'))  # Verifica se o caminho existe